...
function Home() {
  ...
  useEffect(() => {
    axios
      .get('https://mzdmk8p7m8.execute-api.us-east-2.amazonaws.com/categories')
      .then(res => {
  ...
  function handleSubmit(e) {
    e.preventDefault()
    axios
    .get('https://mzdmk8p7m8.execute-api.us-east-2.amazonaws.com/question/' + categoryEl.current.value + '/' + amountEl.current.value)
    .then(res => {
